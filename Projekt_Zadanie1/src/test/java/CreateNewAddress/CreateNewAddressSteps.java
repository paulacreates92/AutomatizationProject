...
public class CreateNewAddressSteps {
    ...
    @Then("I create new address using {string},{string},{string},{string},{string}")
    public void iCreateNewAddressUsingAliasAddressCityPostal_codePhone(String alias, String address, String city, String postal_code, String phone) {
    ...
    @Then("I check if the new address is correct with {string},{string},{string},{string},{string}")
    public void iCheckIfTheNewAddressIsCorrect(String alias, String address, String city, String postal_code, String phone) {
