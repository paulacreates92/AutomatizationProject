Feature: Create new address
  ...
  Scenario Outline: logged user can create and delete new address
    ...
    Then I create new address using "<alias>","<address>","<city>","<postal_code>","<phone>"
    Then I check if the new address is correct with "<alias>","<address>","<city>","<postal_code>","<phone>"
    Then I delete the new address and check if the address was deleted
    And I close the browser
    Examples:
      | alias | address     | city   | postal_code | phone     |
      | Home  | Wschodnia49 | Warsaw | 02-415      | 567432990 |